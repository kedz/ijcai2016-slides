  ...
  \node (O) at (1.7,-2.55) [fill=orange!20,rounded corners] { Oracle Summary};
   ...
   {\begin{minipage}{3cm} 
           $X = \left[ \begin{array}{c} 
                   \visible<9-12>{\phi(s_0)} \\ 
                   \visible<10-12>{\phi(s_1)} \\ 
                   \visible<11-12>{\phi(s_2)} \\ 
                   \visible<12-12>{\phi(s_3)} \\ 
...
\visible<21-22,26>{
  ...
  \node[draw,circle,minimum size=.45cm,inner sep=0pt,dashed,thick] at (n) {}; 
   ...
   {\begin{minipage}{3cm}\scriptsize
           $X = \left[ \begin{array}{c} 
                   \visible<18-22>{\phi(s_0)} \\ 
                   \visible<19-22>{\phi(s_1)} \\ 
                   \visible<20-22>{\phi(s_2)} \\ 
                   \visible<21-22>{\phi(s_3)} \\ 
   \end{array} \right]$ \end{minipage} };
   \node (ARRAY2) at ($(ARRAY)+(3,0)$) [draw] 
   {\begin{minipage}{3.75cm}\scriptsize
           $y_{select} = \left[ \begin{array}{c} 
                   \visible<18-22>{c(s_0,select)} \\ 
                   \visible<19-22>{c(s_1, select)} \\ 
                   \visible<20-22>{c(s_2, select)} \\ 
                   \visible<21-22>{c(s_3, select)} \\ 
   \end{array} \right]$ \end{minipage} };
   \node (ARRAY3) at ($(ARRAY2)+(5,-.50)$) [draw] 
   {\begin{minipage}{3.5cm}\scriptsize 
           $y_{skip} = \left[ \begin{array}{c} 
                   \visible<18-22>{c(s_0, skip)} \\ 
                   \visible<19-22>{c(s_1, skip)} \\ 
                   \visible<20-22>{c(s_2, skip)} \\ 
                   \visible<21-22>{c(s_3, skip)} \\ 
   \end{array} \right]$ \end{minipage} };
  }
   \visible<22>{
   \node at ($(ARRAY2)+(-3,-1.6)$) [align=center] 
   {$\hat{c_1}(s) = w_{a_1} \cdot \phi(s)$  \\
    $\hat{c_0}(s) = w_{a_0} \cdot \phi(s)$};
   }
   \visible<22-26>{
    \node (LP) at ($(ARRAY2)+(2.5,-2.1)$) 
   [align=center,rounded corners,fill=purple!20] 
   {Learned Policy: \\
       cost-sensitive \\
       classification model \\
       $\hat{\pi}(s) = 
       \arg\min_{a \in \{a_1,a_0\}} w_a \cdot \phi(s)$};
...
%   \draw[-] ($(k)+(-.5,-1)$) -- ($(k)+(.5,-1)$) 
%    node[midway,rectangle,text height=.01cm,fill=red!40,yshift=.14cm] (xx) {};
%    \node at ($(k)+(0,-.6)$) [rectangle,minimum size=.45cm,thick,fill=white] {};
%
%
%   \draw[-] ($(n)+(-.5,-1)$) -- ($(n)+(.5,-1)$) 
%    node[midway,rectangle,text height=.15cm,fill=red!40,yshift=.21cm] (xx) {};
%   \node[draw,circle,minimum size=.45cm,inner sep=0pt,dashed,thick] at (k) {}; 
%   \node[draw,circle,minimum size=.45cm,inner sep=0pt,dashed,thick] at (n) {}; 
%    
%}
%
...
%   \node at ($(a)+(0,-.75)$) [] {$Loss$:};
%   \draw[-] ($(m)+(-.5,-1)$) -- ($(m)+(.5,-1)$) 
%    node[midway,rectangle,text height=.10cm,fill=red!40,yshift=.19cm] (xx) {};
%
%   \draw[-] ($(n)+(-.5,-1)$) -- ($(n)+(.5,-1)$) 
%    node[midway,rectangle,text height=.15cm,fill=red!40,yshift=.21cm] (xx) {};
%   \node[draw,circle,minimum size=.45cm,inner sep=0pt,dashed,thick] at (m) {}; 
