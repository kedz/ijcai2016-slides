...
\draw[-,color=purple,very thick,dashed,line width=0.1cm] (w) -- (n); 
  ...
  \draw[-] ($(n)+(-.5,-1)$) -- ($(n)+(.5,-1)$) 
   ...
   \node at ($(l)+(-1.75,-1)$) [] {$c(s_1,select)$};
   \node at ($(n)+(1.75,-1)$) [] {$c(s_1,skip)$};
...
\visible<18>{
  ...
  \draw[-] ($(m)+(-.5,-1)$) -- ($(m)+(.5,-1)$) 
   node[midway,rectangle,text height=.15cm,fill=red!40,yshift=.21cm] (xx) {};
   \node at ($(i)+(-1.75,-1)$) [] {$c(s_1,select)$};
   \node at ($(m)+(1.75,-1)$) [] {$c(s_1,skip)$};
...
%
   ...
   {\begin{minipage}{3cm}\scriptsize
           $X = \left[ \begin{array}{c} 
                   \visible<20-26>{\phi(s_0)} \\ 
                   \visible<21-26>{\phi(s_1)} \\ 
                   \visible<22-26>{\phi(s_2)} \\ 
                   \visible<23-26>{\phi(s_3)} \\ 
   \end{array} \right]$ \end{minipage} };
   \node (ARRAY2) at ($(ARRAY)+(3,0)$) [draw] 
   {\begin{minipage}{3.75cm}\scriptsize
           $y_{select} = \left[ \begin{array}{c} 
                   \visible<20-26>{c(s_0,select)} \\ 
                   \visible<21-26>{c(s_1, select)} \\ 
                   \visible<22-26>{c(s_2, select)} \\ 
                   \visible<23-26>{c(s_3, select)} \\ 
   \end{array} \right]$ \end{minipage} };
   \node (ARRAY3) at ($(ARRAY2)+(4,0)$) [draw] 
   {\begin{minipage}{3.5cm}\scriptsize 
           $y_{skip} = \left[ \begin{array}{c} 
                   \visible<20-26>{c(s_0, skip)} \\ 
                   \visible<21-26>{c(s_1, skip)} \\ 
                   \visible<22-26>{c(s_2, skip)} \\ 
                   \visible<23-26>{c(s_3, skip)} \\ 
   \end{array} \right]$ \end{minipage} };
  }
   \visible<24-26>{
